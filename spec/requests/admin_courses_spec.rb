...
RSpec.describe "/admin_courses", type: :request do
  # AdminCourse. As you add validations to AdminCourse, be sure to
  ...
  describe "GET /index" do
    it "renders a successful response" do
      AdminCourse.create! valid_attributes
  ...
  describe "GET /show" do
    it "renders a successful response" do
      admin_course = AdminCourse.create! valid_attributes
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new AdminCourse" do
        expect {
          post admin_courses_url, params: { admin_course: valid_attributes }
        }.to change(AdminCourse, :count).by(1)
      end

      it "redirects to the created admin_course" do
        post admin_courses_url, params: { admin_course: valid_attributes }
        expect(response).to redirect_to(admin_course_url(AdminCourse.last))
      end
    end

    context "with invalid parameters" do
      it "does not create a new AdminCourse" do
        expect {
          post admin_courses_url, params: { admin_course: invalid_attributes }
        }.to change(AdminCourse, :count).by(0)
      end
